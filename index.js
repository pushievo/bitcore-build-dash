...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-pushi/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-pushi -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-pushi -o bitcore-lib-pushi.js';
    }
